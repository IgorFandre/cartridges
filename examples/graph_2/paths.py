"""
Central path definitions for the graph_2 (lineage cartridge) experiments.
...
Layout:
    examples/graph_2/
    ├── paths.py                 ← this file
    ├── data/base/               generated tree, QA parquets
    └── ...

Results live under repo-root `outputs_graph2/`
(override with $CARTRIDGES_OUTPUT_DIR_GRAPH2).
"""
import os
import re
from pathlib import Path

GRAPH2_ROOT = Path(__file__).resolve().parent
REPO_ROOT   = GRAPH2_ROOT.parent.parent

# ── Data ─────────────────────────────────────────────────────────────────────
DATA_DIR = GRAPH2_ROOT / "data"
BASE_DIR  = DATA_DIR / "base"

BASE_TREE_JSON    = BASE_DIR / "family_tree.json"
BASE_CORPUS       = BASE_DIR / "family_tree_corpus.txt"
BASE_TRAIN_PARQUET = BASE_DIR / "train_lineage.parquet"
BASE_TEST_PARQUET  = BASE_DIR / "test_lineage.parquet"
...
# ── Results ───────────────────────────────────────────────────────────────────
OUTPUTS_DIR = Path(
    os.environ.get("CARTRIDGES_OUTPUT_DIR_GRAPH2", str(REPO_ROOT / "outputs_graph2"))
)
EXP0_DIR = OUTPUTS_DIR / "exp0_icl"
EXP1_DIR = OUTPUTS_DIR / "exp1_selfstudy"
EXP2_DIR = OUTPUTS_DIR / "exp2_star"
