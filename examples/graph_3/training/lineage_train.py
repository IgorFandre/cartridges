...
Usage:
    EXP=exp1 CARTRIDGE_TOKENS=512 python -m examples.graph_3.training.lineage_train
    EXP=exp2 CARTRIDGE_TOKENS=256 MAX_STEPS=300 python -m examples.graph_3.training.lineage_train
"""
import os
...
from examples.graph_3.training.handshake_eval_dataset import HandshakeEvalDataset
    ...
    return TrainConfig(
        ...
        generate_evals=[
            GenerationEvalConfig(
                dataset=HandshakeEvalDataset.Config(
                ...
                name_for_wandb=f"handshake_{exp}_test",
                generate_max_new_tokens=512,  # free-form CoT → distance / not connected
                batch_size=8,
                temperature=0.0,
            )
        ],
