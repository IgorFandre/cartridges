...
The split is by-person and is identical across variants by reusing
the same seed and people list (only the swapped name is renamed
inside the split lists).
